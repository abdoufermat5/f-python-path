...
class Vector2D:
    ...
    typecode = "d"  # each vector component will be represented as an 8-byte
    # double precision float when exporting to bytes
...
class ShortVector2D(Vector2D):
    typecode = "f"  # each vector component will be represented as a 4-byte
    # single precision float when exporting to bytes
